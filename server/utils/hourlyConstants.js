...
// Skillhub slots — same 9:30–7:30 range. Lunch (2:00–3:00, id 's1400') is kept
// as a working slot flagged isLunch, since counselors sometimes work through
// lunch and need to log activity there.
const SKILLHUB_SLOTS = [
    ...
    { id: 's1400', lbl: '2:00', end: '3:00', mins: 60, isLunch: true },
    { id: 's1500', lbl: '3:00', end: '4:00', mins: 60 },
    { id: 's1600', lbl: '4:00', end: '5:00', mins: 60 },
    { id: 's1700', lbl: '5:00', end: '6:00', mins: 60 },
    { id: 's1800', lbl: '6:00', end: '7:00', mins: 60 },
