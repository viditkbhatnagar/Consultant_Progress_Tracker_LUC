...
export const exportCommitmentsToExcel = (commitments, filename = 'commitments') => {
    ...
    const data = commitments.map(commitment => ({
        ...
        'Consultant': commitment.consultantName || 'N/A',
        ...
        'Conversion Probability': commitment.conversionProbability != null ? commitment.conversionProbability + '%' : 'N/A',
        'Meetings Done': commitment.meetingsDone || 0,
        'Achievement %': (commitment.status === 'achieved' || commitment.admissionClosed) ? 100 : 0,
